            ...
            <div class="row items_row">
                <div class="col-4">
                    <div class="item sec_06-item">
                        ...
                        <p class="item_text"><span class="title_text">Поймете свою миссию,</span> визию, ценности и сфокусируетесь на истинных целях.</p>
                    </div>
                </div>
                <div class="col-4">
                    <div class="item sec_06-item">
                        ...
                        <div class="program_lists four--colums">
                            ...
                            <div class="program_lists_item">
                                ...
                                <ul class="program_list">
                                   <li class="list_item">• Получить доступ к глубинным ценностям;</li>
                                   <li class="list_item">• Определить внутренние препятствия;</li>
                                   <li class="list_item">• Создать собственную карту жизненного успеха.</li>
                                </ul>
                            </div>
                            <div class="program_lists_item">
                                <p class="lists_item_title title_text">Ценности:</p>
                                <ul class="program_list">
                                    <li class="list_item">• Идентификация ложных и истинных ценностей;</li>
                            ...
                            <div class="program_lists_item">
                                ...
                                <ul class="program_list">
                                   <li class="list_item">• Знакомство с глубинными комплексами и страхами;</li>
                                   <li class="list_item">• Осознание запретов и разрешений.</li>
                                </ul>
                            </div>
                            <div class="program_lists_item">
                                <p class="lists_item_title title_text">Понимание успеха</p>
                                <ul class="program_list">
                                    <li class="list_item">• Понимание успеха в каждой из десяти сфер;</li>
                                    <li class="list_item">• Куда я инвестирую свою энергию;</li>
                                    <li class="list_item">• Хватает ли мне сил заниматься тем, чем действительно хочется. Масштаб моего успеха.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="program_period">
                        ...
                        <div class="program_lists">
                            ...
                            <div class="program_lists_item">
                                <p class="lists_item_title title_text">Цели:</p>
                                <ul class="program_list">
                                    <li class="list_item">• Определить личную миссию;</li>
                                    <li class="list_item">• Освоить навыки:</li>
                                    <li class="list_item">- понимания своих эмоций и эмоций других людей;</li>
                                    <li class="list_item">- построения продуктивных отношений;</li>
                                    <li class="list_item">- создания ресурсных состояний в трудных ситуациях.</li>
                                </ul>
                            </div>
                            <div class="program_lists_item">
                                <p class="lists_item_title title_text">Эмоциональный <br> интеллект:</p>
                                <ul class="program_list">
                                   ...
                                   <li class="list_item">• Как я влияю своими эмоциями на окружающий мир.</li>
                                </ul>
                            </div>
                            <div class="program_lists_item">
                                <p class="lists_item_title title_text">Моя миссия:</p>
                                <ul class="program_list">
                                    <li class="list_item">• Проработка собственной миссии исходя из своих истинных ценностей и желаний;</li>
                    ...
                    <div class="program_period">
                        ...
                        <div class="program_lists">
                            ...
                            <div class="program_lists_item">
                                ...
                                <li class="list_item">• Освоение навыка self-coaching;</li>
                                <li class="list_item">• Создание плана “Моя программа изменений”.</li>
                                </ul>
                            </div>
                            <div class="program_lists_item">
                                <p class="lists_item_title title_text">Моя визия:</p>
                                <ul class="program_list">
                                <li class="list_item">• Создание желаемого образа себя в будущем;</li>
                                <li class="list_item">• Self-coaching. Как задавать себе правильные вопросы;</li>
                                <li class="list_item">• Инструменты для выхода <br> из стрессовых ситуаций;</li>
                                <li class="list_item">• Умение рассмотреть любую ситуацию со стороны.</li>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="coach_card">
                            ...
                            <button class="coach_accordion_trigger coach_card_button"><span class="main_title text--blue">читать польностью</span><img src="img/ar-3.png" alt="Указатель" class="coach_btn_arrow"></button>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="coach_card">
    ...
    <section id="sec_11">
        <div class="container">
            ...
            <div class="row sec_11-row_2">
                <div class="col-4 col-offset-3">
                    <div class="sec_11-item item">
                        <p class="item_text title_text">Чтобы попасть на BootCamp в Карпатах, нужно пройти два этапа отбора. </p>
                    </div>
                    <div class="sec_11-item item">
                        <p class="item_text text"><span class="title_text">- Первый —</span> ваше резюме\CV\профиль <br> на LinkedIn. </p>
                    </div>
                    <div class="sec_11-item item">
                        <p class="item_text text"><span class="title_text">- Второй —</span> личное собеседование <br> с командой проекта. </p>
                    </div>
                    <div class="sec_11-item item">
                        <p class="item_text text">Нам важно ближе познакомиться с каждым из потенциальных участников, понять личную мотивацию и ценности, узнать об ожиданиях от проекта.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="sec_12-item item">
                        <p class="item_text text">Мы долго искали спокойное и уютное место для релакса и активной саморефлексии. <br> <span class="title_text">И выбрали лучшую “зеленую” гостиницу Украины 2016 года - Таор Карпаты.</span></p>
                    </div>
                    <div class="sec_12-item item">
                        <p class="item_text text">Гостиница расположена в экологически чистой горной зоне на берегу реки Стрый.</p>
                    </div>
                    <div class="sec_12-item item">
                        <p class="item_text text">Таор специализируется на настоящем эко-отдыхе:</p>
                    </div>
                    <div class="sec_12-item item">
                ...
                <div class="col-8 col--nopadding">
                    <div class="slider desctop">
                        <div class="slide">
                            <img class="md-trigger" data-modal="modal_picture-1" src="img/hotels/1.png" alt="Комфортный отель">
                            <img class="md-trigger" data-modal="modal_picture-2" src="img/hotels/2.png" alt="Комфортный отель">
                            <img class="md-trigger" data-modal="modal_picture-3" src="img/hotels/3.png" alt="Комфортный отель">
                        </div>
                        <div class="slide">
                            <img class="md-trigger" data-modal="modal_picture-4" src="img/hotels/4.png" alt="Комфортный отель">
                            <img class="md-trigger" data-modal="modal_picture-5" src="img/hotels/5.png" alt="Комфортный отель">
                            <img class="md-trigger" data-modal="modal_picture-6" src="img/hotels/6.png" alt="Комфортный отель">
                        </div>
                        <div class="slide">
                            <img class="md-trigger" data-modal="modal_picture-7" src="img/hotels/7.png" alt="Комфортный отель">
                            <img class="md-trigger" data-modal="modal_picture-8" src="img/hotels/8.png" alt="Комфортный отель">
                            <img class="md-trigger" data-modal="modal_picture-9" src="img/hotels/9.png" alt="Комфортный отель">
                        </div>
                    </div>
                    <div class="slider mobile tc">
                        <div class="wrap">
                            <img src="img/hotels/1.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img src="img/hotels/2.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img  src="img/hotels/3.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img src="img/hotels/4.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img  src="img/hotels/5.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img  src="img/hotels/6.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img src="img/hotels/7.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img src="img/hotels/8.png" alt="Комфортный отель">
                        </div>
                        <div class="wrap">
                            <img  src="img/hotels/9.png" alt="Комфортный отель">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="sec_13">
        <div class="container">
            ...
            <div class="row sec_13-row_1">
                <div class="col-2">
                    <div class="item schedule_item">
                        <p class="schedule_time text--blue main_title">6:00 – 7:00. </p>
                        <p class="schedule_text text">Утренняя йога. <br /> Умное тело. <br> Встреча солнца. Энергетические практики</p>
                    </div>
                </div>
                <div class="col-2">
                    <div class="item schedule_item">
                        <p class="schedule_time text--blue main_title">7:00 – 8:00. </p>
                        <p class="schedule_text text">Прогулка</p>
                    </div>
                </div>
                <div class="col-2">
                    <div class="item schedule_item">
                        <p class="schedule_time text--blue main_title">8:00 – 9:00. </p>
            ...
            <div class="row sec_13-row_2">
                <div class="col-2">
                    <div class="item schedule_item">
                        <p class="schedule_time text--blue main_title">14:00 – 16:30.</p>
                        <p class="schedule_text text">Обед и прогулка (скандинавская ходьба, поход и т.д.)</p>
                    </div>
                </div>
                <div class="col-2">
                    <div class="item schedule_item">
                        <p class="schedule_time text--blue main_title">16:30 – 18:30. </p>
                ...
                <div class="col-2">
                    <div class="item schedule_item">
                        ...
                        <p class="schedule_text text">Вечерние активности: живая кухня, лесной квест, баня</p>
                    </div>
                </div>
                <div class="col-2">
                    <div class="item schedule_item">
    ...
    <div class="hidden">
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-1">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/1.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-2">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/2.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-3">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/3.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-4">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/4.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-5">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/5.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-6">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/6.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-7">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/7.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-8">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/8.png" alt="Hotel">
            </div>
        </div>
        ...
        <div class="md-modal md-effect-8 md_large" id="modal_picture-9">
            <div class="md-content">
                ...
                <img src="img/hotels/hotels-big/9.png" alt="Hotel">
            </div>
        </div>
